...
double componentCheck::CheckPlanarity(pcl::PointIndices::Ptr indices_src, pcl::PointIndices::Ptr indices_trg, double thr)
{
...
bool componentCheck::IsPlanar(pcl::PointIndices::Ptr indices_src, pcl::PointIndices::Ptr indices_trg, double thr_plan, double thr_angle)
{
